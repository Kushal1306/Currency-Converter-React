...
function App() {
  ...
  <div className='w-full h-screen flex flex-wrap
   justify-center items-center bg-cover bg-no-repeat' style={{backgroundImage:`url(https://us.images.westend61.de/0001397732pw/cropped-hand-holding-indian-currency-against-white-background-EYF06181.jpg)`}}>
   <div className='w-full'>
    ...
    border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30'>
     <form onSubmit={(e)=>{
      ...
      py-3 rounded-lg'>Convert {from} To {to}</button>
     </form>
    </div>
   </div>
  </div>
